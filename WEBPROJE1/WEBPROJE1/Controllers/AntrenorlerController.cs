...
namespace WEBPROJE1.Controllers
{
    public class AntrenorlerController : Controller
    {
        ...
        public AntrenorlerController(SporContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TamAd,UzmanlikAlani,ResimUrl")] Antrenor antrenor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TamAd,UzmanlikAlani,ResimUrl")] Antrenor antrenor)
        {
            if (id != antrenor.Id)
            {
                return NotFound();
