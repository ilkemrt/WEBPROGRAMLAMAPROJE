...
namespace WEBPROJE1.Migrations
{
    ...
    [Migration("20251209111244_IlkKurulum")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WEBPROJE1.Models.Hizmet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WEBPROJE1.Models.Randevu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WEBPROJE1.Models.Uye", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WEBPROJE1.Models.Uye", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WEBPROJE1.Models.Randevu", b =>
                {
                    ...
                    b.HasOne("WEBPROJE1.Models.Hizmet", "Hizmet")
                        .WithMany("Randevular")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WEBPROJE1.Models.Uye", "Uye")
                        .WithMany("Randevular")
                        .HasForeignKey("UyeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
